# -*- coding: utf-8 -*-
"""Instagram Analytics.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VQVkxd_s0p8WaE2qfjkLjYFOnuk_WHwi
"""

#!pip3 install -U datapane

#!datapane login --server=https://datapane.com/ --token="d727c75ff103fcccb5c41d6ed1cdc406b9c3246f"
...
#Top 10 media likers bar plot
top_10_likers = df_likers.username.value_counts()[:10].plot(kind='bar', title='Top 10 media likers', grid=True, figsize=(12,6))

#dp.Plot(df_likers.username.value_counts()[:10].plot(kind='bar', title='Top 10 media likers', grid=True, figsize=(12,6)))

#figs.append(dp.Plot(df_likers.username.value_counts()[:10].plot(kind='bar', title='Top 10 media likers', grid=True, figsize=(12,6))))

#Top 10 media likers pie chart
df_likers.username.value_counts()[:10].plot(kind='pie', title='Top 10 media likers distribution', autopct='%1.1f%%', figsize=(12,6))

#figs.append(dp.Plot(df_likers.username.value_counts()[:10].plot(kind='pie', title='Top 10 media likers distribution', autopct='%1.1f%%', figsize=(12,6))))

#Top 10 commenters bar plot
df_commenters['username'].value_counts()[:10].plot(kind='bar', figsize=(12,6), title='Top 10 post commenters')

#figs.append(dp.Plot(df_commenters['username'].value_counts()[:10].plot(kind='bar', figsize=(12,6), title='Top 10 post commenters')))
...
#Day of the week you received most comments
...
#figs.append(dp.Plot(df_commenters.created_at.dt.weekday.value_counts().sort_index().plot(kind='bar', figsize=(12,6), title='Comments per day of the week (0 - Sunday, 6 - Saturday)')))

#Time you receive most comments
df_commenters.created_at.dt.hour.value_counts().sort_index().plot(kind='bar', figsize=(12,6), title="Time you received most comments")

#figs.append(dp.Plot(df_commenters.created_at.dt.hour.value_counts().sort_index().plot(kind='bar', figsize=(12,6), title="Time you received most comments")))

# Create a column to show when a a comment was created in Chicago time
df_commenters['created_at_ch'] = df_commenters.created_at_utc.dt.tz_localize('UTC').dt.tz_convert('America/Chicago')

df_commenters.created_at_ch.dt.hour.value_counts().sort_index().plot(kind='bar', figsize=(12,6),title="Time you received most comments in CDT")

#figs.append(dp.Plot(df_commenters.created_at_ch.dt.hour.value_counts().sort_index().plot(kind='bar', figsize=(12,6),title="Time you received most comments in CDT")))

#dp.Report(*figs).publish(name='Instagram_Analytics', open=True)
